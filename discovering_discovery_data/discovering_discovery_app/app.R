        ...
        tabItems(
            ...
            tabItem(tabName = "connections",
                    ...
                    fluidRow(column(12,
                                    box(width = 12, 
                                        h2("Conclusion"),
                                        p("Maybe the extent of a song's influence is in part due to chance; \"One More Time\" is widely considered the most influential track on", em("Discovery"), "in part due to its mass appeal, though I've always considered \"Face to Face\" and \"Digital Love\" to be more impressive tracks. Another possibility, and a much more likely one, relates to the fact that my data is in itself arbitrary, and perhaps there's an answer in data science somewhere else. The subjectivity versus objectivity debate about art is an ancient one, but considering the formulaic nature of modern dance and electronic music, this may the genre to settle the debate someday. But Thomas Bangalter and Guy-Manuel de Homen-Christo never meant to solve an age-old philosophical puzzle; they just wanted to make catchy songs. In that respect, they triumphed. Happy listening.")
                             ))
                    )
